<template>
  <view class="container">
    ...
    <view class="profile-header">
      ...
      <view class="edit-button" @click="navigateTo('/pages/pet-profile/edit')">
    ...
    <view class="pet-details">
      <view class="detail-item">
        ...
        <text class="detail-value">豆豆</text>
      </view>
      <view class="detail-item">
        <text class="detail-label">宠物种类</text>
        <text class="detail-value">猫</text>
      </view>
      <view class="detail-item">
        <text class="detail-label">品种</text>
        <text class="detail-value">英短</text>
      </view>
      <view class="detail-item">
        <text class="detail-label">性别</text>
        <text class="detail-value">男</text>
      </view>
      <view class="detail-item">
        <text class="detail-label">出生日期</text>
        <text class="detail-value">2022-05-15</text>
      </view>
      <view class="detail-item">
        <text class="detail-label">体重</text>
        <text class="detail-value">4.5 kg</text>
      </view>
    </view>
